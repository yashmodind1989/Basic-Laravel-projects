  ...
  <form method="post" action="{{ route('orders.store')}}">
    ...
    <div class="row">
       <div class="col-sm-12">
          ...
          <input type="text" name="txtweight" id="txtweight" value=""/>
       </div>
    </div>
    <div class="row">
       <div class="col-sm-12">
          <label>Source Address:</label> <br/>
          <textarea name="txtsource" id="txtsource" rows="5" cols="45"></textarea>
       </div>
    </div>
    <div class="row">
       <div class="col-sm-12">
          <label>Destination Address:</label> <br/>
          <textarea name="txtdestination" id="txtdestination" rows="5" cols="45"></textarea>
       </div>
    </div>
    <div class="row">
       <div class="col-sm-12">
          <input type="submit" name="btnparceladd" id="btnparceladd" class="btn btn-success" value="Submit"/>
       </div>
    </div>
  </form>
</div>
