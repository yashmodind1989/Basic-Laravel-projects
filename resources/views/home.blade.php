...
@section('content')
<section id="home">
        <div class="bg-holder" style="background-image:url({{ asset('public/assets/img/gallery/header-bg.png')}});background-position:center;background-size:cover;">
        </div>
        <!--/.bg-holder-->
      ...
      <section id="aboutUs">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6 text-center mb-6 mb-md-0 order-0 order-md-1"><img class="w-100" src="{{ asset('public/assets/img/gallery/about-us.png')}}" alt="..." /></div>
      ...
      <section>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6 text-center mb-6 mb-md-0"><img class="w-100" src="{{ asset('public/assets/img/gallery/how-to-apply.png')}}" alt="..." /></div>
      ...
      <section class="bg-primary-gradient" id="faq">
        <div class="bg-holder" style="background-image:url({{ asset('public/assets/img/gallery/faq-bg.png')}});background-position:right;background-size:contain;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          <div class="row flex-center">
            ...
            <div class="col-md-6"><img class="w-100" src="{{ asset('public/assets/img/gallery/faq.png')}}" alt="..." /></div>
          </div>
                      ...
                      <div class="col-md-4 mb-5 mb-md-0">
                        <div class="card card-span h-100 shadow-primary">
                          <div class="card-body my-3">
                            ...
                            <div class="align-items-xl-center d-block d-xl-flex px-3 mt-3 align-self-end"><img class="img-fluid me-3 me-md-2 me-lg-3" src="{{ asset('public/assets/img/gallery/isak.png')}}" width="50" alt="" />
                      ...
                      <div class="col-md-4 mb-5 mb-md-0">
                        <div class="card card-span h-100 shadow-primary">
                          <div class="card-body my-3">
                            ...
                            <div class="align-items-xl-center d-block d-xl-flex px-3 mt-3 align-self-end"><img class="img-fluid me-3 me-md-2 me-lg-3" src="{{ asset('public/assets/img/gallery/simon.png')}}" width="50" alt="" />
                              <div class="flex-1 align-items-center pt-2">
                      ...
                      <div class="col-md-4 mb-5 mb-md-0">
                        <div class="card card-span h-100 shadow-primary">
                          <div class="card-body my-3">
                            ...
                            <div class="align-items-xl-center d-block d-xl-flex px-3 mt-3 align-self-end"><img class="img-fluid me-3 me-md-2 me-lg-3" src="{{ asset('public/assets/img/gallery/petter.png')}}" width="50" alt="" />
                              <div class="flex-1 align-items-center pt-2">
      ...
      <section>
        <div class="bg-holder" style="background-image:url({{ asset('public/assets/img/gallery/footer-bg.png')}});background-position:left;background-size:contain;padding:5px 3px;">
        </div>
        <!--/.bg-holder-->
          ...
          <div class="row flex-center">
            ...
            <div class="col-md-6 col-xl-3 order-1">
              ...
              <ul class="list-unstyled list-inline mb-6 mb-md-0 text-center text-md-end text-xl-start">
                <li class="list-inline-item mr-2"><a class="text-decoration-none" href="#!"><img class="list-social-icon" src="{{ asset('public/assets/img/icons/i.png')}}" alt="..." /></a></li>
                <li class="list-inline-item mr-2"><a class="text-decoration-none" href="#!"><img class="list-social-icon" src="{{ asset('public/assets/img/icons/t.png')}}" alt="..." /></a></li>
                <li class="list-inline-item mr-2"><a class="text-decoration-none" href="#!"><img class="list-social-icon" src="{{ asset('public/assets/img/icons/f.png')}}" alt="..." /></a></li>
              </ul>
            </div>
          </div>
        </div>
